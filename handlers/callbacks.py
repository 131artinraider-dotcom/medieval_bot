...
async def button_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # انتخاب کلاس (ثبت‌نام) - فقط خود کاربر میتونه بزنه ولی نیازی به پنل‌لاک نداره
    ...
    # ==========================================
    # 3. همه دکمه‌های دیگه - چک مالکیت پنل
    # ==========================================
    ...
    # ==========================================
    # 6. دکمه‌های دانجن - شروع پنل جدید
    # ==========================================
